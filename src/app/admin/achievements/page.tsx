      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex justify-end">
          {loading ? (
            ...
            <Button
              className="bg-[#0F0F0F] text-white px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base"
...
// import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
// import { Badge } from "@/components/ui/badge"
// import { Target, Award, Plus, Trash2, Edit, Search } from "lucide-react"
// import { Button } from "@/components/ui/button"
// import { Input } from "@/components/ui/input"
// import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table"
// import { AdminLayout } from "@/components/dashboard/AdminLayout"
...
//         const response = await axios.get(`/api/get-performance`, {
//           headers: {
//             Authorization: token,
//           },
//         })
...
//           // Map achievements
//           const mappedAchievements = player.achievements.map((ach: {
//             _id: string;
//             title: string;
//             description: string;
//             accolade: string;
...
//             description: ach.description,
//             type: ach.accolade,
//             date: new Date(ach.date).toLocaleDateString('en-US', { month: 'short', year: 'numeric' })
//           }))
...
//           } else {
//             toast.error(error.message || "An error occurred while fetching player data")
//           }
//         } else {
//           toast.error("An unexpected error occurred")
//         }
...
//       const response = await axios.post("/api/add-achievement", {
//         userId: playerId,
//         title: newAchievement.title,
//         description: newAchievement.description,
//         accolade: newAchievement.type,
...
//   const handleDeleteAchievement = async (id: string) => {
//     try {
//       // In a real implementation, you would call an API to delete the achievement
//       setAchievements(achievements.filter(ach => ach.id !== id))
//       toast.success("Achievement deleted successfully")
//     } catch {
...
//       const response = await axios.patch("/api/update-performance", {
//         userId: playerId,
//         playerName: playerData.name,
//         skills: {
//           ballControl: skillsData[0].current,
...
//         toast.success("Player performance updated successfully!")
//       } else {
//         toast.error(data.message || "Failed to update player performance")
//       }
//     } catch (error) {
//       if (axios.isAxiosError(error)) {
//         toast.error(error.response?.data?.message || "Failed to update player performance")
...
//                 </div>
//                 <Button
//                   className="bg-[#0F0F0F] text-white w-full sm:w-auto"
//                   onClick={() => setPlayerId(searchTerm)}
//                 >
//                   Load Player
//                 </Button>
//               </div>
...
//                 <h3 className="text-lg font-medium text-gray-900">No Player Selected</h3>
//                 <p className="text-gray-500">Enter a player ID and click &quot;Load Player&quot; to view performance data</p>
//               </div>
//             </CardContent>
//           </Card>
//         )}
