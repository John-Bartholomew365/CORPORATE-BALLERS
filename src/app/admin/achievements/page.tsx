...
//                         </Badge>
//                         <Badge variant="secondary" className="text-[16px] px-4 py-2 border border-[#B0B3B8]">
//                             {playerData.category}
//                         </Badge>
//                     </div>
//                 </div>
...
//                                                         className="bg-[#0F0F0F] text-white ml-3"
//                                                     >
//                                                         Save
//                                                     </Button>
//                                                 ) : (
...
//                     <Button className="bg-[#0F0F0F] text-white px-6 py-3 cursor-pointer">
//                         Save All Changes
//                     </Button>
//                 </div>
//             </div>
        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 mt-2">Player Performance Management</h1>
                        <p className="text-gray-600">Manage achievements and skills for players</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <Input
