            ...
            <section className="py-20 bg-gradient-to-br from-green-50 to-emerald-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="lg:text-[16px] leading-tight text-[14px] text-gray-600 max-w-3xl mx-auto">
                            Ready to join our football academy or have questions? <br /> We would love to hear from you.
                        </p>
                    </div>
